-- =========================================================================
-- Clearhouse LLP Employee Portal — Schema migration (V2)
-- Run this in the SQL editor of your own Supabase project (BYO).
-- Order: 01_schema.sql → 02_seed.sql → run scripts/seed-demo-users.ts
-- =========================================================================
